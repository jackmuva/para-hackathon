...
export async function createAgent(userId: string | (() => string), collection: Collection, documentIds?: string[], params?: any): Promise<OpenAIAgent>{
    ...
    const confirmAndSendSlackMessage = FunctionTool.from(
        async({ confirmation, message }: { confirmation: string; message: string; }) => {
            ...
            return "Message not sent successfully. Check to see if your Slack integration is enabled.";
        },
        {
        ...
        },
        {
            ...
            parameters: {
                ...
                properties: {
                    question: {
                        type: "string",
                        description: "question about Paragon or Salesforce contact"
                    },
                },
                required: ["question"],
            },
